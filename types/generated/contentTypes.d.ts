...
export interface ApiAudiovisualProductionAudiovisualProduction
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gai_savoir_production: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    slug: Attribute.UID<
    ...
    category: Attribute.String &
      Attribute.DefaultTo<'production-audiovisuelle'>;
...
export interface ApiIdeaIdea extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::idea.idea', 'title'> & Attribute.Required;
    content: Attribute.RichText;
    card_image: Attribute.Media;
    content_components: Attribute.DynamicZone<
      ['content.image', 'content.text', 'content.carousel']
    >;
    category: Attribute.String & Attribute.DefaultTo<'articles'>;
    subcategory: Attribute.Relation<
      'api::idea.idea',
      'manyToOne',
      'api::subcategory.subcategory'
...
export interface ApiMigrationMigration extends Schema.CollectionType {
  ...
  info: {
    ...
    description: 'Table for tracking executed migrations';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    executed_at: Attribute.DateTime;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubcategorySubcategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::subcategory.subcategory', 'name'> &
      Attribute.Required;
    audiovisual_productions: Attribute.Relation<
      'api::subcategory.subcategory',
      'oneToMany',
      'api::audiovisual-production.audiovisual-production'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::audiovisual-production.audiovisual-production': ApiAudiovisualProductionAudiovisualProduction;
